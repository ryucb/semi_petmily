                   ...
                   <!-- 콘텐츠 영역 -->
                    <table style="margin-left: auto; margin-right:auto">
                        ...
                        <tr>  
                            ...
                            <td class="second-td">고세빈</td>
                            <td class="third-td"><button type="button" onclick="toggle1();">수정하기</button></td>
                        </tr>
                        <div>
                        <tr class="row1" style="display: none;">
                            <td></td>
                            <td style="line-height:40px; padding-left:50px;"><input type="email" style="height:25px; width: 230px;"/> </td> 
                        ...
                        <tr class="row4" style="display: none;">
                            <td class="subrow2"></td>
                            <td class="subrow2" style= "padding-left:50px;">
                                <input style="line-height: 40px; width: 250px;" id="nowpw" name="nowpw" type="text" placeholder="현재 비밀번호"/>
                            </td>
                            <td class="subrow2"></td>
                        </tr>
                        <tr class="row4" style="display: none;">
                            <td class="subrow2"></td>
                            <td class="subrow2" style = "padding-left:50px;">
                                <input style="line-height: 40px; width: 250px;" id="newpw" name="newpw" type="text" placeholder="새 비밀번호"/>
                            </td>
                            <td class="subrow2"></td>
                        </tr>
                        <tr class="row4" style="display: none;">
                            <td class="subrow3"></td>
                            <td class="subrow3" style = "padding-left:50px; padding-bottom: 10px;">
                                <input style="line-height: 40px; width: 250px;" id="pwck" name="pwck" type="text" placeholder="새 비밀번호 확인"/>
                            </td>
                            <td class="subrow3"></td>
                        </tr>
