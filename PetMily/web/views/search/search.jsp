        ...
        <div class="filter_box mt-5">
          ...
          <article class="filter_btn_box row mt-4">
            ...
            <div class="col-10 row justify-content-between">
              <button type="button" class="btn" onclick="">프로 펫 시터</button>
              <button type="button" class="btn" value="약물복용" onclick="location.replace('<%=request.getContextPath()%>/filterSearch/takingDrug')">약물 복용</button>
        ...
        <header class="mt-4 row justify-content-center">
          ...
          <div class="col-5">
            <ul class="nav justify-content-end">
              <li class="nav-item inactive" id="popularity" value="popularity">인기 순</li>
              <li class="nav-item inactive" id="recentlyPost">글 등록 순</li>
            </ul>
  ...
  <script>
  	...
  	$(function(){
  		...
  		$("#recentlyPost").click(()=>{
  			...
  			$.ajax({
  				url:"<%=request.getContextPath()%>/search/filterRecentPost",
